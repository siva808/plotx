      ...
      <div style={{ background: info.bg, padding:"64px 48px", textAlign:"center", position:"relative", overflow:"hidden" }}>
        ...
        <div style={{ position:"relative", zIndex:2, maxWidth:"600px", margin:"0 auto" }}>
          ...
          <div style={{ display:"flex", gap:"16px", justifyContent:"center", flexWrap:"wrap" }}>
            ...
            <a href={`https://wa.me/${WA_NUMBER}?text=Hi%20PlotX%2C%20I'm%20interested%20in%20${encodeURIComponent(info.label)}`}
              target="_blank" rel="noopener noreferrer"
              style={{
                display:"inline-flex", alignItems:"center", gap:"8px",
      ...
      <div style={{
        ...
        <div style={{ display:"flex", gap:"16px", flexWrap:"wrap", alignItems:"center" }}>
          ...
          <div style={{ display:"flex", gap:"10px" }}>
            ...
            <a href={`https://wa.me/${WA_NUMBER}?text=Hi%20PlotX%2C%20I'd%20like%20to%20enquire%20about%20your%20properties.`}
              target="_blank" rel="noopener noreferrer"
              style={{
                display:"inline-flex", alignItems:"center", gap:"8px",
      ...
      <div style={{ borderBottom:"1px solid rgba(255,255,255,0.08)", padding:"28px 48px" }}>
        <div style={{ maxWidth:"1200px", margin:"0 auto", display:"flex", alignItems:"center", justifyContent:"space-between", flexWrap:"wrap", gap:"20px" }}>
          ...
          <div style={{ display:"flex", gap:"12px", alignItems:"center" }}>
            ...
            <SocialIcon href={`https://wa.me/${WA_NUMBER}`} label="WhatsApp" bg="rgba(37,211,102,0.15)" hoverBg="rgba(37,211,102,0.35)">
...
function WAFloat() {
  return (
    <a href={`https://wa.me/${WA_NUMBER}?text=Hi%20PlotX%2C%20I'd%20like%20to%20enquire%20about%20a%20property.`}
      target="_blank" rel="noopener noreferrer"
      style={{
